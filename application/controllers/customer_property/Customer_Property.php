...
class Customer_Property extends Base_Controller
{
    ...
    public function rental_property()
    {
        ...
        $this->load->view("customer_property/view_customer_rental_property", $data);
    ...
    public function lease_property()
    {
        ...
        $this->load->view("customer_property/view_customer_lease_property", $data);
        $this->load->view("common/footer");
    }
    ...
    public function sell_property()
    {
        ...
        $this->load->view("customer_property/view_customer_sell_property", $data);
        $this->load->view("common/footer");
    }
    ...
    public function accept_sell_property()
    {
        ...
        $upload_dir = APPPATH . '../images/customer_images/property/';
        ...
        if (!empty(array_filter($_FILES['pro-image']['name']))) {
            echo "<pre>";
            // Loop through each file in files[] array
            foreach ($_FILES['pro-image']['tmp_name'] as $key => $value) {
                $file_tmpname = $_FILES['pro-image']['tmp_name'][$key];
                $file_name = $_FILES['pro-image']['name'][$key];
                $file_size = $_FILES['pro-image']['size'][$key];
                $file_ext = pathinfo($file_name, PATHINFO_EXTENSION);
                $fileNewName1 = time() . $file_name;
                // Set upload file path
                $filepath = $upload_dir . $fileNewName1;
                ...
                if (in_array(strtolower($file_ext), $allowed_types)) {
                    ...
                    if (move_uploaded_file($file_tmpname, $filepath)) {
                        ...
                        array_push($property_image, "images/customer_images/property/" . $fileNewName1);
                    }
        ...
        if ($data['main_type_of_property'] == "residential") {
            ...
            if ($data['sub_categories'] == "normal_ready") {
                ...
                $data['customer_name'] = $_POST['name1a'];
                ...
                $data['customer_name'] = $_POST['name1b'];
                ...
                $data['customer_name'] = $_POST['name1c'];
            ...
            $data['customer_name'] = $_POST['name2'];
            ...
            $data['customer_name'] = $_POST['name3'];
            ...
            $data['customer_name'] = $_POST['name4'];
        ...
        $conbrid_property = $this->Base_Models->AddValues("conbrid_customer_sell_property", $data);

        if (isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category'] == "Customer") {
            // send notifcaiton to customer and company
            $data1 = $this->Base_Models->CustomeQuary("select conbrid_customers.id as customer_id from conbrid_customers where
            state='" . $_POST['state_id'] . "' and city='" . $_POST['city_id'] . "' and user_id != 0 and user_id!='" . $_SESSION['userdata']['id'] . "'");
            $company_name = $_SESSION['userdata']['details'];
            $notification_title = "Customer Sell Property";
            $notification_text = "There is a Customer Sell Property post by <b>" . $company_name[0]['customer_name'] . " Company </b> you might have interest";
           // echo "<pre>";
            //print_r($_SESSION);

            if (!empty($data1)) {
                for ($k = 0; $k < count($data1); $k++) {
                    $data2['post_by_company_id'] = $_SESSION['userdata']['customers_id'];
                    $data2['customer_id'] = $data1[$k]['customer_id'];
                    $data2['title'] = $notification_title;
                    $data2['text'] = $notification_text;
                    $data2['datetime'] = date("Y-m-d h:i:s");
                    $data2['post_id'] = $conbrid_property;
                    $data2['type'] = "Sell Property by customer";
                    $this->Base_Models->AddValues("conbrid_customer_notification", $data2);
                }
            }
            ...
            //send to company
            $data11 = $this->Base_Models->CustomeQuary("select conbrid_companies.id as company_id from conbrid_companies where
            state='" . $_POST['state_id'] . "' and city='" . $_POST['city_id'] . "'");
            if (!empty($data11)) {
                for ($k = 0; $k < count($data11); $k++) {
                    $data22['post_by_company_id'] = $_SESSION['userdata']['customers_id'];
                    $data22['company_id'] = $data11[$k]['company_id'];
                    $data22['title'] = $notification_title;
                    $data22['text'] = $notification_text;
                    $data22['datetime'] = date("Y-m-d h:i:s");
                    $data22['job_post_id'] = $conbrid_property;

                    $data22['type'] = "Sell Property by customer";
                    $this->Base_Models->AddValues("conbrid_company_notification", $data22);
                }
            }
    ...
    public function accept_rental_property()
    {
        ...
        if ($data['main_type_of_property'] == "residential") {
            ...
            $data['customer_name'] = $_POST['name1'];
            ...
            $data['builtup_area_measure_type'] = $_POST['builtup_area_measure_type1'];
        ...
        $conbrid_property = $this->Base_Models->AddValues("conbrid_customer_rental_property", $data);
        ...
        if (isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category'] == "Customer") {
            ...
            state='" . $_POST['state_id'] . "' and city='" . $_POST['city_id'] . "' and user_id != 0 and user_id!='" . $_SESSION['userdata']['id'] . "'");
            $company_name = $_SESSION['userdata']['details'];
            $notification_title = "Customer Rental Property";
            $notification_text = "There is a Customer Rental Property post by <b>" . $company_name[0]['customer_name'] . " Company </b> you might have interest";
           // echo "<pre>";
            //print_r($_SESSION);
            ...
            if (!empty($data1)) {
                for ($k = 0; $k < count($data1); $k++) {
                    ...
                    $data2['datetime'] = date("Y-m-d h:i:s");
                    $data2['post_id'] = $conbrid_property;
                    $data2['type'] = "Rental Property by customer";
                    $this->Base_Models->AddValues("conbrid_customer_notification", $data2);
                }
            }
            ...
            if (!empty($data11)) {
                for ($k = 0; $k < count($data11); $k++) {
                    ...
                    $data22['type'] = "Rental Property by customer";
                    $this->Base_Models->AddValues("conbrid_company_notification", $data22);
                }
            }
    ...
    public function accept_lease_property()
    {
        ...
        $data['city_id'] = $_POST['city_id'];
        $data['pincode'] = $_POST['pincode'];
        if ($_SESSION['userdata']['category'] == "Customer") {
            $data['user_type'] = $_SESSION['userdata']['category'];
            $data['user_id'] = $_SESSION['userdata']['id'];
        }
        $data['main_type_of_property'] = $_POST['main_type_of_property'];
        ...
        $conbrid_property = $this->Base_Models->AddValues("conbrid_customer_lease_property", $data);
        ...
        if (isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category'] == "Customer") {
            ...
            state='" . $_POST['state_id'] . "' and city='" . $_POST['city_id'] . "' and user_id != 0 and user_id!='" . $_SESSION['userdata']['id'] . "'");
            $company_name = $_SESSION['userdata']['details'];
            $notification_title = "Customer Lease Property";
            $notification_text = "There is a Customer Lease Property post by <b>" . $company_name[0]['customer_name'] . " Company </b> you might have interest";
           // echo "<pre>";
            //print_r($_SESSION);
            ...
            if (!empty($data1)) {
                for ($k = 0; $k < count($data1); $k++) {
                    ...
                    $data2['datetime'] = date("Y-m-d h:i:s");
                    $data2['post_id'] = $conbrid_property;
                    $data2['type'] = "Lease Property by customer";
                    $this->Base_Models->AddValues("conbrid_customer_notification", $data2);
                }
            }
            ...
            if (!empty($data11)) {
                for ($k = 0; $k < count($data11); $k++) {
                    ...
                    $data22['type'] = "Lease Property by customer";
                    $this->Base_Models->AddValues("conbrid_company_notification", $data22);
                }
            }
