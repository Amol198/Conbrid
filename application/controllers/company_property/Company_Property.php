...
class Company_Property extends Base_Controller
{
        ...
        public function rental_property()
    {
        ...
        $this->load->view("company_property/view_rental_property",$data);
    ...
    public function lease_property()
    {
        ...
        $this->load->view("company_property/view_lease_property",$data);
        $this->load->view("common/footer");
    }
    ...
    public function sell_property()
    {
        ...
        $this->load->view("company_property/view_sell_property", $data);
        $this->load->view("common/footer");
    }
...
####################################   Rent Property data start #############################################
        ...
        $data5 ['display_contents'] = array (
                        ...
                        foreach ($data5['table_data'] as $key => $row) {
                            $data5['table_data'][$key]['actions'] = " <a  href='" . base_url('company_property/Company_Property/view_rental_property_post/'.$data5['table_data'][$key]['id']). "' class='btn btn-warning'>View</a>";
...
####################################   Sell Property data start #############################################
                        ...
                        $data6 ['display_contents'] = array (
                                        ...
                                        foreach ($data6['table_data'] as $key => $row) {
                                            $data6['table_data'][$key]['actions'] = " <a  href='" . base_url('company_property/Company_Property/view_sell_property_post/'.$data6['table_data'][$key]['id']). "' class='btn btn-warning'>View</a>";
 ...
 ####################################   Sell Property data end #############################################
    ...
    public function accept_sell_property()
    {
        ...
        $upload_dir = APPPATH . '../images/company_images/property/';
            ...
            foreach ($_FILES['pro-image']['tmp_name'] as $key => $value) {
                ...
                if (in_array(strtolower($file_ext), $allowed_types)) {
                    ...
                    if (move_uploaded_file($file_tmpname, $filepath)) {
                        ...
                        array_push($property_image, "images/company_images/property/" . $fileNewName1);
                    }
  ...
  // start
      ...
      if(isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category']=="Companies"){
        ...
        if (! empty($data1)) {
            $notification_title = "Company Sell Property"; 
            $notification_text = "There is a Company Sell Property post by <b>" . $company_name[0]['company_name']. " Company </b> you might have interest";
            for ($k = 0; $k < count($data1); $k ++) {
                ...
                $data2['type'] = "Sell Property by company";
        ...
        public function accept_rental_property()
    {
        ...
        $conbrid_property = $this->Base_Models->AddValues("conbrid_rental_property", $data);
            ...
            if(isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category']=="Companies"){
              ...
              if (! empty($data1)) {
                  $notification_title = "Company Rental Property"; 
                  $notification_text = "There is a Company Rental Property post by <b>" . $company_name[0]['company_name']. " Company </b> you might have interest";
                  for ($k = 0; $k < count($data1); $k ++) {
                      $data2['post_by_company_id'] = $_SESSION['userdata']['company_id'];
                      $data2['customer_id'] = $data1[$k]['customer_id'];
                      $data2['title'] = $notification_title;
                      ...
                      $data2['type'] = "Rental Property by company";
                      $this->Base_Models->AddValues("conbrid_customer_notification", $data2);
                  }
              } 
    ...
    public function accept_lease_property()
    {
        ...
        $conbrid_property = $this->Base_Models->AddValues("conbrid_lease_property", $data);
            ...
            if(isset($_SESSION['userdata']['category']) && $_SESSION['userdata']['category']=="Companies"){
              ...
              if (! empty($data1)) {
                  $notification_title = "Company Lease Property"; 
                  $notification_text = "There is a Company Lease Property post by <b>" . $company_name[0]['company_name']. " Company </b> you might have interest";
                  for ($k = 0; $k < count($data1); $k ++) {
                      $data2['post_by_company_id'] = $_SESSION['userdata']['company_id'];
                      $data2['customer_id'] = $data1[$k]['customer_id'];
                      $data2['title'] = $notification_title;
                      ...
                      $data2['type'] = "Lease Property by company";
                      $this->Base_Models->AddValues("conbrid_customer_notification", $data2);
                  }
              } 
