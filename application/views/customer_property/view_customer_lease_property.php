...
<section id="team-sev" class="padding bg_light"
	...
	<form enctype='multipart/form-data'
		...
		action="<?php echo base_url("customer_property/Customer_Property/accept_lease_property")?>">
  ...
  <select  id="main_type_of_property" name="main_type_of_property" class="form-control">
    ...
    <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group">
        ...
        <input  class="form-control" name="name1" type="text"> </div>   
...
<div class="col-md-2 form-group">
 ...
 <div class="col-md-2 form-group" >
      ...
      <div class="col-md-2 form-group">
					<label>Upload E-Stamp agreement<sup>*</sup></label>
                ...
                <div class="col-md-2 form-group">
					<label>Upload electricity bill <sup>*</sup></label>
...
<label
        style="font-size: 12px;">Upload Multiple Image At One Time </label>
    ...
    <?php }?>
			   ...
			   <label style="font-size: 12px; color: red;" id="city_label"></label> <br>
				...
				<label>Pincode<sup style="color: red;">*</sup></label> <input
					class="form-control" name="pincode" type="number" id="pincode"> <label
...
function  validateForm(){
    ...
    switch($("select[name=main_type_of_property]").val()){
     ...
     else if ($("input[name=pro-image]").val()==""){
            alert("please upload property images ");
            return false;
     }
