	...
	<div class="row">
	    ...
	    <div class="col-md-9 row" style="background: white; text-align:center;"><br>
			...
			<div class="col-md-6 row">
				...
				<label><b><?php  if(isset($budget)) echo $budget;?></b></label>
			</div>
			<div class="col-md-6 row">
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				...
				<a href="<?php echo base_url("Services/update_customer_property_post_for_customer_login/3/".$notification_details['notification_id']."")?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> I am not interested</a>
			</div>
		</div>
	</div>
</div>     
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				...
				<a href="<?php echo base_url("Services/update_customer_property_post_for_customer_login/2/".$notification_details['notification_id']."")?>" class="btn btn-info"><i class="fa fa-check" aria-hidden="true"></i> I am interested</a>
			</div>
		</div>
	</div>
</div>     
