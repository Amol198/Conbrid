...
<section id="team-sev" class="padding bg_light"
	...
	<form enctype='multipart/form-data'
		...
		action="<?php echo base_url(index_page()."customer_property/Customer_Property/accept_rental_property")?>">
    ...
    <?php }?>
			   ...
			   <label style="font-size: 12px; color: red;" id="city_label"></label> <br>
				...
				<label>Pincode<sup style="color: red;">*</sup></label> <input
					class="form-control" type="number" name="pincode" id="pincode"> <label
