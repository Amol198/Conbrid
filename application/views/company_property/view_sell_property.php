...
<section id="team-sev" class="padding bg_light"
	...
	<form enctype="multipart/form-data"
		...
		action="<?php echo base_url(index_page()."company_property/Company_Property/accept_sell_property")?>">
...
<fieldset class="form-group">
    ...
    <?php }?>
			   ...
			   <label style="font-size: 12px; color: red;" name="city_id" id="city_label"></label> <br>
